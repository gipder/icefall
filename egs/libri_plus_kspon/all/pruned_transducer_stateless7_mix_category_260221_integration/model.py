    ...
    def forward(
        ...
        Args:
          ...
          y:
            ...
            utterance.
          category_y:
            A ragged tensor with 2 axes [utt][label]. It contains categorized
            labels of each utterance.
          prune_range:
        ...
        """
        # sos_categorized_y_padded: [B, C + 1], start with SOS.
        sos_categorized_y = add_sos(categorized_y, sos_id=blank_id)
        sos_categorized_y_padded = sos_categorized_y.pad(mode="constant",
                                                         padding_value=blank_id)
        categorized_y_len = y_lens
        """
