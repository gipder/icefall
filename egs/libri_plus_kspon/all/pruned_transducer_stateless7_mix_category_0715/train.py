...
import os
from my_utils import cluster_tokens_using_ipa
...
def run(rank, world_size, args):
    ...
    bias = 2
    token_cluster = cluster_tokens_using_ipa(token_dict, params.num_category-bias)
    ...
    logging.info(f"Token to cluster table is ready, "
                 ...
                 f"num of category(hyparam): {params.num_category} "
