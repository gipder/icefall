...
basedir="pruned_transducer_stateless7_pkd_sampling_refactoring"
task="6m_prune5_wt_gt_wt_kd_wt_kd_scale0.01_wo_sampling" #_wt_sampling_wt_sam_scale1.0"
