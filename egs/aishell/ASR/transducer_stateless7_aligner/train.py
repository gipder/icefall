...
def get_parser():
    ...
    parser.add_argument(
        "--use-independent-aligner",
        type=str2bool,
        default=False,
        help="Whether to use independent aligner",
    )
...
def compute_loss(
    ...
    use_independent_aligner = params.use_independent_aligner
    ...
    with torch.set_grad_enabled(is_training):
        ...
        ret = model(
            ...
            use_independent_aligner=use_independent_aligner,
        )
    ...
    if use_aligner_encoder:
        ...
        org_loss = ret["independent_aligner_loss"]
    else:
