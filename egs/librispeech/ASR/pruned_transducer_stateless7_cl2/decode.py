...
def decode_one_batch(
    ...
    if params.decoding_method == "fast_beam_search":
        ...
        hyp_tokens = fast_beam_search_with_nbest_rescoring(
            ...
            max_states=params.max_states,
            max_contexts=params.max_contexts,
            ngram_lm_scale_list=[1.0],
            num_paths=params.num_paths,
            G=k2.Fsa.from_dict(torch.load("/home/sskim/work/icefall/egs/librispeech/ASR/data/lang_bpe_500/3gram.pt")),
            sp=sp,
            word_table=k2.SymbolTable.from_file("/home/sskim/work/icefall/egs/librispeech/ASR/data/lang_bpe_500/words.txt"),
            oov_word="<UNK>",
...
def main():
    ...
    if "fast_beam_search" in params.decoding_method:
        ...
        if "nbest" in params.decoding_method:
            ...
            if "rescoring" in params.decoding_method:
                params.suffix += f"-rescoring"
