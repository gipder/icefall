...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        simple_loss, pruned_loss, simple_py_std, simple_px_std = model(
            x=feature,
            x_lens=feature_lens,
            y=y,
    ...
    info["simple_py_std_loss"] = simple_py_std.detach().cpu().item()
    info["simple_px_std_loss"] = simple_px_std.detach().cpu().item()
